...
# =====================================================
# 2. BUILDER PROFILE (NO FILES HERE)
# =====================================================
class BuilderProfile(models.Model):
    ...
    description = models.TextField(
        help_text="Describe your company and solar plans."
    )
...
# =====================================================
# 3. BUILDER PORTFOLIO IMAGES (MULTIPLE FILE UPLOADS)
# =====================================================
class BuilderPortfolioImage(models.Model):
    ...
    image = models.ImageField(
        upload_to='builder_portfolio/'
    )
    uploaded_at = models.DateTimeField(auto_now_add=True)

    def __str__(self):
        return f"{self.builder.company_name} - Portfolio Image"
...
class LandAnalysis(models.Model):
    ...
    def __str__(self):
        return f"Land Analysis ({self.latitude}, {self.longitude})"
...
class Proposal(models.Model):
    ...
    INVESTMENT_CHOICES = (
        ...
        ('self_invest', 'Landowner Invests'),
        ('builder_invest', 'Builder Invests'),
    )

    landowner = models.ForeignKey(
        User,
        on_delete=models.CASCADE,
        related_name='proposals_sent_by_landowner'
    )
    builder = models.ForeignKey(
        User,
        on_delete=models.CASCADE,
    ...
    land_analysis = models.ForeignKey(
        LandAnalysis,
        on_delete=models.CASCADE,
    ...
    message = models.TextField(
        help_text="Message from Landowner to Builder"
    )
    ...
    status = models.CharField(
        ...
        default='pending_builder'
    )

    investment_choice = models.CharField(
        max_length=20,
    ...
    def __str__(self):
        return f"Proposal → {self.builder.username}"
